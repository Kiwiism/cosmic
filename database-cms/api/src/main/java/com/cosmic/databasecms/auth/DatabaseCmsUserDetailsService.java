package com.cosmic.databasecms.auth;
...
@Service
public class DatabaseCmsUserDetailsService implements UserDetailsService {
    private final JdbcTemplate jdbc;

    public DatabaseCmsUserDetailsService(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
